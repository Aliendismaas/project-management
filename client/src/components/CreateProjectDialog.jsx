...
const CreateProjectDialog = ({ isDialogOpen, setIsDialogOpen }) => {
    ...
    return (
        <div className="fixed inset-0 bg-black/20 dark:bg-black/60 backdrop-blur flex items-center justify-center text-left z-50 flex-col overflow-y-scroll no-scrollbar ">
            <div className="flex flex-col overflow-y-scroll no-scrollbar items-center p-6 w-full max-w-lg ">
