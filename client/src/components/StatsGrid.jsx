...
export default function StatsGrid() {
    ...
    return (
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 my-9 hover:cursor-pointer">
            {statCards.map(
                // eslint-disable-next-line no-unused-vars
                ({ icon: Icon, title, value, subtitle, bgColor, textColor }, i) => (
                    <div key={i} className="bg-white dark:bg-zinc-950 dark:bg-linear-to-br dark:from-zinc-800/70 dark:to-zinc-900/50 
                    border border-zinc-200 dark:border-zinc-800 hover:border-zinc-300
                     dark:hover:border-zinc-700 transition duration-200 rounded-md" >
